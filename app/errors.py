...
class HTTPBadRequest(HTTPError):
    def __init__(self, code='BAD_REQUEST', cause=None, headers=None):
        super().__init__(
            status.HTTP_400,
            code,
            cause,
...
class HTTPNotFound(HTTPError):
    def __init__(self, code='NOT_FOUND', cause=None, headers=None):
        super().__init__(
            status.HTTP_404,
            code,
            cause,
...
class HTTPConflict(HTTPError):
    def __init__(self, code='CONFLICT', cause=None, headers=None):
        super().__init__(
            status.HTTP_409,
            code,
            cause,

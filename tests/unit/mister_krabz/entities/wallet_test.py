...
from mister_krabz.entities.wallet import Wallet, WalletAccountAlreadySet, WalletAccountNotSet
...
class TestWallet(TestCase):
    ...
    def test_set_wallet_account(self):
        self.wallet.set_wallet_account(
            WalletAccount(self.db, self.wallet, uuid4())
        )
    ...
    async def test_get_account(self):
        ...
        self.wallet.set_wallet_account(
            WalletAccount(self.db, self.wallet, account.id)
        )
